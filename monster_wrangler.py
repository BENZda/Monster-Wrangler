...
class Game():
    ...
    def __init__(self, player, monster_group):
        ...
        purple_image = pygame.image.load("images/purple_monster.png")
        yellow_image = pygame.image.load("images/yellow_monster.png")
        
        # This list cooresponds to the monster_type attribute | Monster type is an int 0 -> blue, 1 -> green, 2 -> purple, 3 -> yellow
...
class Player(pygame.sprite.Sprite):
    ...
    def __init__(self):
        ...
        self.warp_sound.set_volume(0.1)
    ...
    def warp(self):
        """Warps the player to the bootom 'safe zone'"""
        if self.warps > 0:
            self.warps -= 1
...
my_game.pause_game("Monster Wrangler", "Press 'ENTER' to start playing!")
